...
(function() {
  ...
  function initToolbarButton() {
    ...
    document.querySelector("#ytEmbedButton").addEventListener('click', async () => {
      ...
      if (youtubeChannelName == null || youtubeChannelName ==  "") return;
      ...
      console.log(videoId + " is video id")
    ...
    var existCondition = setInterval(function() {
      ...
      console.log("****************************************TRYING")
      if (
        document.querySelector("button[aria-label*='Theat']") &&
        document.querySelector("div.community-points-summary") &&
        document.querySelector("div.video-player__container") &&
        document.querySelector('div.chat-input__buttons-container').firstChild
      ) {
